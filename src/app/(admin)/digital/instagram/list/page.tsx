...
export const metadata: Metadata = {
  title: "Instagram Advertising List | AlluNeed Admin",
  description: "View and manage Instagram advertising products list",
};

export default function InstagramAdvertisingList() {
  return (
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
            <h3 className="font-medium text-black dark:text-white">
              Instagram Advertising Products List
            </h3>
          </div>
          <div className="p-6.5">
            <div className="text-center py-10">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                View and manage your Instagram advertising products and campaigns.
              </p>
