...
export const metadata: Metadata = {
  title: "Branding Services | AlluNeed Admin",
  description: "Manage branding services and brand identity projects",
};
          ...
          <div className="p-6.5">
            <div className="text-center py-10">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Manage branding projects, brand identity, and brand strategy development.
              </p>
              <div className="mt-6">
