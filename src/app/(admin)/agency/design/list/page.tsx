...
export const metadata: Metadata = {
  title: "Design Services List | AlluNeed Admin",
  description: "View and manage design services list",
};

export default function DesignServicesList() {
  return (
          ...
          <div className="p-6.5">
            <div className="text-center py-10">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                View and manage your design services and creative projects.
              </p>
