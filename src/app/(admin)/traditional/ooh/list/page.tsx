...
export const metadata: Metadata = {
  title: "OOH Advertising List | AlluNeed Admin",
  description: "View and manage OOH advertising products list",
};
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
            <h3 className="font-medium text-black dark:text-white">
              OOH Advertising Products List
            </h3>
          </div>
          <div className="p-6.5">
            <div className="text-center py-10">
              <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">
                OOH Advertising Products
              </h2>
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                View and manage your Out-of-Home advertising products and campaigns.
              </p>
